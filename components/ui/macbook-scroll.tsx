...
export const MacbookScroll = ({
  ...
  return (
    <div
      ref={ref}
      className="md:min-h-[190vh] lg:min-h-[250vh] min-h-[150vh] flex flex-col items-center lg:py-28 md:pb-1 md:mt-1 justify-start flex-shrink-0 [perspective:800px] transform md:scale-75 lg:scale-100 scale-[0.49] sm:scale-7"
    >
      <motion.h2
        style={{
    ...
    <div className="relative [perspective:800px]">
      ...
      >
        ...
        <video className='object-contain hidden md:flex justify-center items-center bg-black absolute rounded-lg inset-0 h-full w-full' autoPlay muted loop>
          <source src={"https://res.cloudinary.com/ddeqh8bh3/video/upload/v1745241766/Chipset_hero_video_nfeuzq.mp4"} type="video/mp4"/>
        </video>
      </motion.div>
    </div>
  );
