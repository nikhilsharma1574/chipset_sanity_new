...
import PairSitting from './PairSitting';
          ...
          <div className='flex justify-center items-center w-full'>
             <div className='flex flex-1 md:p-6 z-10'>
               {/* <div className='md:flex flex-col'> */}
                  <p data-aos="fade-right" className='md:text-4xl bg-red-500 w-full font-bold text-xl lg:text-[50px] md:font-semibold md:px-24 md:py-12'><span className='font-heading'>What is</span> CH<span className='text-[#f6a339]'>i</span>PSET</p>
                  ...
                  <div className='2 md:flex-1 my-6 flex justify-center items-center '>
